...
// const run1 = new Running([39, -12], 52, 24, 170);
// const cycling1 = new Cycling([39, -12], 52, 24, 170);
//
...
class App {
  ...
  _newWorkout(e) {
    ...
    //if Activity running create running object, check data if its valid
    if (type === 'running') {
    ...
    //if Activity cycling  create cycling object, check data if its valid
    if (type === 'cycling') {
